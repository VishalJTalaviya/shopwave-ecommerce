                            ...
                            {getAllOrder.map((order) => {
                                ...
                                return (
                                    <>
                                            ...
                                            return (
                                                <tr key={index} className="text-pink-300">
                                                    ...
                                                    <select 
                                                        ...
                                                        className={order.status === 'pending' ? 'text-red-800' : 'text-green-600'}
                                                    >
                                                    ...
                                                    <td onClick={() => orderDelete(order.id, item.id)} className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 text-red-500 cursor-pointer ">
                                                        Delete
                                                    </td>
                                                </tr>
                                            )
                                        ...
                                        <td colSpan="16" className="h-12 px-6 text-md border-t border-l first:border-l-0 border-pink-100 text-slate-700 bg-slate-100 font-bold fontPara">
                                            Total Distinct Items: {order.cartItems.length}
                                        </td>
                                    </tr>
                                    </>
                                )
