...
const TrackCard = ({ title, description, svgPath }) => (
    <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
        <div className=" border-2 hover:shadow-xl hover:shadow-pink-200 border-grey-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg">
