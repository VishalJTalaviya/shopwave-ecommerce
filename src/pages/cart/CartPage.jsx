...
import { decrementQuantity, deleteAllFromCart, deleteFromCart, incrementQuantity } from "../../redux/cartSlice";
                ...
                <div className="mx-auto max-w-2xl py-8 lg:max-w-7xl">
                    ...
                    <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                        ...
                        <div className="mt-16 text-center">
                          ...
                          />
                          <h2 className="text-2xl font-medium text-gray-900 hover:text-blue-700 underline mt-4">
                          <Link to={'/allproduct'}>Your cart is empty</Link>
                          </h2>
