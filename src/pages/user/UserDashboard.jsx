...
//                                                                 <div className="text-sm font-medium text-gray-900 break-words">#{id}</div>
//                                                             </div>
...
//                                                                 <div className={`text-sm font-medium ${order.status === 'confirmed' ? 'text-green-800' : 'text-red-800'} first-letter:uppercase`}>{order.status}</div>
                                            ...
                                            <div className="w-full border-r border-pink-100 bg-pink-50 md:max-w-xs">
                                                ...
                                                <div className="p-8">
                                                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-1">
                                                        ...
                                                        <div className="mb-4">
                                                            <div className="text-sm font-semibold">Order Status</div>
                                                            <div className={`text-sm font-medium ${status === 'confirmed' ? 'text-green-800' : 'text-red-800'} first-letter:uppercase`}>{status}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
