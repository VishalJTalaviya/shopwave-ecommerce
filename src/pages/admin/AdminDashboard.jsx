...
// }, 0);
 ...
 // Calculate the total number of distinct items in orders
//  const totalDistinctItemsInOrders = getAllOrder.reduce((total, order) => {
                        ...
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-pink-50 hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl" >
                                    ...
                                    {/* <h2 className="title-font font-medium text-3xl text-pink-400 fonts1" >{totalItemsInOrders}</h2> */}
                                    {/* <h2 className="title-font font-medium text-3xl text-pink-400 fonts1" >{totalDistinctItemsInOrders}</h2> */}
